...
public class MasterIDGenerator {
    ...
    private static final int currentNodeId = minNodeId - 1;
    ...
    private static int nodeIdIncrement(int currentNodeId){
        ...
        if (currentNodeId > maxNodeId) {
            System.out.print("Running out of NodeIDs\n");
    ...
    // Get new incremental nodeID
    public int getNewNodeId(int nodeId) {
        return nodeIdIncrement(nodeId);
    }
